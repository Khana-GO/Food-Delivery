  ...
  return (
    ...
    >
      ...
      <Tabs.Screen
        ...
        options={{
          tabBarIcon: ({ focused }) => (
            <TabIcon name="search" label="Explore" focused={focused} size={iconSize} labelSize={labelSize} />
          ),
        }}
      />
      <Tabs.Screen
        ...
        options={{
          tabBarIcon: ({ focused }) => (
            <TabIcon name="clock" label="Orders" focused={focused} size={iconSize} labelSize={labelSize} />
          ),
        }}
      />
      <Tabs.Screen
        ...
        options={{
          tabBarIcon: ({ focused }) => (
            <TabIcon name="heart" label="Favorites" focused={focused} size={iconSize} labelSize={labelSize} />
          ),
        }}
      />
      <Tabs.Screen
