...
export const getBaseUrl = (): string => {
  ...
  // Last resort: localhost is only correct for web/simulators. Configure
  // EXPO_PUBLIC_API_URL_MOBILE (see apps/mobile/.env.example) for a device.
  console.warn(
    "[axios] Could not detect the API host. Set EXPO_PUBLIC_API_URL_MOBILE in apps/mobile/.env"
  );
